                            ...
                            <div className="timeline">
                                <div className="timeline-card timeline-card-success">
                                    <div className="timeline-head px-4 pt-3">
                                        <div className="h5">Masters in Information Technology <span className="text-muted h6">from International
                                            University</span> </div>
                                    </div>
                                ...
                                <div className="timeline-card timeline-card-success">
                                    <div className="timeline-head px-4 pt-3">
                                        <div className="h5">Bachelor of Computer Science <span className="text-muted h6">from Regional College</span>
                                        </div>
                                    </div>
                                    <div className="timeline-body px-4 pb-4">
                                ...
                                <div className="timeline-card timeline-card-success">
                                    <div className="timeline-head px-4 pt-3">
                                        <div className="h5">Science and Mathematics <span className="text-muted h6">from Mt. High Scool</span> </div>
                                    </div>
                                    <div className="timeline-body px-4 pb-4">
