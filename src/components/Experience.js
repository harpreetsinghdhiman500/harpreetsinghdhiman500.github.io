                            ...
                            <div className="timeline">
                                <div className="timeline-card timeline-card-info">
                                    <div className="timeline-head px-4 pt-3">
                                        <div className="h5">Frontend Developer <span className="text-muted h6">at Creative Agency</span></div>
                                    </div>
                                    <div className="timeline-body px-4 pb-4">
                                        <div className="text-muted text-small mb-3">May, 2015 - Present</div>
                                ...
                                <div className="timeline-card timeline-card-info">
                                    <div className="timeline-head px-4 pt-3">
                                        <div className="h5">Graphic Designer <span className="text-muted h6">at Design Studio</span></div>
                                    </div>
                                    <div className="timeline-body px-4 pb-4">
                                        <div className="text-muted text-small mb-3">June, 2013 - May, 2015</div>
                                ...
                                <div className="timeline-card timeline-card-info" data-aos="fade-in" data-aos-delay="400">
                                    <div className="timeline-head px-4 pt-3">
                                        <div className="h5">Junior Web Developer <span className="text-muted h6">at Indie Studio</span></div>
                                    </div>
                                    <div className="timeline-body px-4 pb-4">
                                        <div className="text-muted text-small mb-3">Jan, 2011 - May, 2013</div>
